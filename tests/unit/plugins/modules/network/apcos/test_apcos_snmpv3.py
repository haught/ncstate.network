...
from ansible_collections.ncstate.network.plugins.modules.network.apcos import apcos_snmpv3
from ansible_collections.community.network.tests.unit.plugins.modules.utils import set_module_args
from ansible_collections.ncstate.network.tests.unit.plugins.modules.network.apcos.apcos_module import TestApcosModule, load_fixture
...
class TestApcosSnmpv3Module(TestApcosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ncstate.network.plugins.modules.network.apcos.apcos_snmpv3.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ncstate.network.plugins.modules.network.apcos.apcos_snmpv3.load_config')
