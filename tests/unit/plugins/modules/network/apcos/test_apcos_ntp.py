...
from ansible_collections.ncstate.network.plugins.modules.network.apcos import apcos_ntp
...
class TestApcosNtpModule(TestApcosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ncstate.network.plugins.modules.network.apcos.apcos_ntp.get_config')
