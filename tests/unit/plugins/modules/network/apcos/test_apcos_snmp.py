...
from ansible_collections.ncstate.network.plugins.modules.network.apcos import apcos_snmp
...
class TestApcosSnmpModule(TestApcosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ncstate.network.plugins.modules.network.apcos.apcos_snmp.get_config')
