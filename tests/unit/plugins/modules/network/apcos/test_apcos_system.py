...
from ansible_collections.ncstate.network.plugins.modules.network.apcos import apcos_system
...
class TestApcosSystemModule(TestApcosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ncstate.network.plugins.modules.network.apcos.apcos_system.get_config')
